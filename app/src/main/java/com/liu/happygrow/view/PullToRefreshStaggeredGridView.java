package com.liu.happygrow.view;
...
public class PullToRefreshStaggeredGridView extends PullToRefreshBase<StaggeredGridView> {
    ...
    private static final PullToRefreshBase.OnRefreshListener<StaggeredGridView> defaultOnRefreshListener = new OnRefreshListener<StaggeredGridView>() {
